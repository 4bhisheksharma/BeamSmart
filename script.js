...
const firebaseConfig = {
  ...
  const lightStateRef = firebase.database().ref("car/lightState");
  const obstacleDistanceRef = firebase.database().ref("car/obstacleDistance");
  const commandRef = firebase.database().ref("car/command");
